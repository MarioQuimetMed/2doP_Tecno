...
const flatResults = computed(() => {
    ...
    if (results.value.destinos.length > 0) {
        ...
        results.value.destinos.forEach((item) =>
    ...
    if (results.value.planes.length > 0) {
        ...
        results.value.planes.forEach((item) =>
            flat.push({ type: "item", ...item })
        );
    }
    ...
    if (results.value.viajes.length > 0) {
        ...
        results.value.viajes.forEach((item) =>
            flat.push({ type: "item", ...item })
        );
    }
...
<template>
    <div class="relative">
        ...
        >
            ...
            <kbd
                class="hidden lg:inline-flex items-center gap-1 px-1.5 py-0.5 text-xs rounded bg-white/20"
            >
                <span>Ctrl</span>
                <span>K</span>
            </kbd>
                        ...
                        <div class="max-h-[60vh] overflow-y-auto">
                            ...
                            >
                                ...
                                <p class="text-sm mt-2">
                                    Busca en destinos, planes de viaje y viajes
                                    programados
                                </p>
                            </div>
                            ...
                            >
                                <div
                                    class="animate-spin w-8 h-8 border-4 border-current border-t-transparent rounded-full mx-auto mb-3"
                                ></div>
                                <p>Buscando...</p>
                            </div>
                            ...
                            <div v-else class="py-2">
                                ...
                                <div v-if="results.destinos.length > 0">
                                    ...
                                    >
                                        <MapPinIcon
                                            class="w-5 h-5 mt-0.5 flex-shrink-0 text-green-500"
                                        />
                                ...
                                <div v-if="results.viajes.length > 0">
                                    ...
                                    >
                                        <CalendarIcon
                                            class="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-500"
                                        />
                                        <div class="flex-1 min-w-0">
                                            <p
                                                class="font-medium truncate"

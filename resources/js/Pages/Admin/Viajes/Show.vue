...
const cambiarEstado = () => {
    router.patch(route('viajes.cambiar-estado', props.viaje.id), {
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-8 text-white">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div>
                                <h1 class="text-2xl font-bold">{{ viaje.plan_viaje?.nombre }}</h1>
                                <div class="flex items-center mt-2 text-indigo-100">
                                    <MapPinIcon class="h-5 w-5 mr-1" />
                                    {{ viaje.plan_viaje?.destino?.nombre_lugar }}, {{ viaje.plan_viaje?.destino?.ciudad }}, {{ viaje.plan_viaje?.destino?.pais }}
                                </div>
                            </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">
                                            {{ formatCurrency(stats.ingresos_generados) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                <div class="flex items-center mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                                    <div class="flex-shrink-0 h-10 w-10 rounded-full bg-gradient-to-br from-green-500 to-teal-600 flex items-center justify-center">
                                ...
                                <div class="space-y-6">
                                    <div
                                        v-for="(actividades, dia) in actividadesPorDia"
                                        :key="dia"
                                        class="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden"
                                    >
                                        <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 flex items-center">
                                        ...
                                        <div class="p-4 space-y-3">
                                            ...
                                            >
                                                <div v-if="actividad.hora_inicio" class="flex-shrink-0 w-16 text-sm text-indigo-600 dark:text-indigo-400 font-medium">
                                    ...
                                    <div
                                        v-if="Object.keys(actividadesPorDia).length === 0"
                                        class="text-center py-8 text-gray-500 dark:text-gray-400"
                                    >
                                        <ListBulletIcon class="h-12 w-12 mx-auto mb-4 text-gray-300 dark:text-gray-600" />
                                        <p>No hay actividades definidas para este plan de viaje</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                <div class="flex items-center justify-between mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10 rounded-full bg-gradient-to-br from-yellow-500 to-orange-600 flex items-center justify-center">
                                            <TicketIcon class="h-5 w-5 text-white" />
                                        </div>
                                        <div class="ml-4">
                                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                                                Últimas Ventas
                                ...
                                <div v-if="viaje.ventas?.length > 0" class="space-y-3">
                                    <div
                                ...
                                <div
                                    ...
                                    class="text-center py-8 text-gray-500 dark:text-gray-400"
                                >
                                    <TicketIcon class="h-12 w-12 mx-auto mb-4 text-gray-300 dark:text-gray-600" />
                                    <p>No hay ventas registradas para este viaje</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="font-medium text-gray-900 dark:text-gray-100">
                                            {{ formatCurrency(viaje.plan_viaje?.precio_base) }}/persona
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-6">
                                ...
                                <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-4 mb-4">
                                    <div
                                        ...
                                        :style="{ width: ((viaje.cupos_totales - viaje.cupos_disponibles) / viaje.cupos_totales) * 100 + '%' }"
                                    ></div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4 text-center">
                                    <div class="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                        ...
                                        <p class="text-xs text-green-700 dark:text-green-300">Disponibles</p>
                                    </div>
                                    <div class="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                        <p class="text-2xl font-bold text-blue-600 dark:text-blue-400">
                                            {{ viaje.cupos_totales - viaje.cupos_disponibles }}
                                        </p>
                                        <p class="text-xs text-blue-700 dark:text-blue-300">Vendidos</p>
                                    </div>
                                </div>
                            </div>
                        </div>

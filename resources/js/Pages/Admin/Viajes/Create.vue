                                    ...
                                    <div class="flex items-center mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                                Elija el plan para programar el viaje
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                <div class="p-6">
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <!-- Cupos Totales -->
                                        <div>
                                            <InputLabel for="cupos_totales" value="Cupos Disponibles *" />
                                            <div class="relative mt-1">
                                            ...
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                                Número máximo de pasajeros que pueden reservar
                                            </p>
                                ...
                                <div class="p-6">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="mt-4 space-y-2">
                                                ...
                                                <div class="flex items-center justify-between text-sm">
                                                    ...
                                                    <span class="font-medium text-gray-900 dark:text-gray-100">
                                                        {{ planSeleccionado?.duracion_dias || 0 }} días
                                                    </span>
                                                </div>
                                                <div class="flex items-center justify-between text-sm">
                                                    <span class="text-gray-500 dark:text-gray-400 flex items-center">
                                            ...
                                            <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                                                <div class="flex items-center justify-between">
                                                    <span class="text-gray-500 dark:text-gray-400">Precio por persona:</span>
                                                    <span class="text-xl font-bold text-indigo-600 dark:text-indigo-400">
                                                        {{ planSeleccionado ? formatCurrency(planSeleccionado.precio_base) : "$0.00" }}
                                                    </span>
                                                </div>
                                                <div class="mt-2 flex items-center justify-between text-sm">
                                                    <span class="text-gray-500 dark:text-gray-400">Ingreso potencial:</span>
                                                    <span class="font-medium text-green-600 dark:text-green-400">
                                                        {{ planSeleccionado ? formatCurrency(planSeleccionado.precio_base * form.cupos_totales) : "$0.00" }}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mt-6 space-y-3">
                                        <PrimaryButton
                                            ...
                                            :disabled="form.processing || !form.plan_viaje_id || !form.fecha_salida"
                                        >

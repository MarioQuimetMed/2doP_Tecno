...
const deleteViaje = (viaje) => {
    if (confirm(`¿Está seguro de eliminar el viaje del ${formatDate(viaje.fecha_salida)}?`)) {
                                ...
                                <tr>
                                    ...
                                    >
                                        <div class="flex items-center">
                                            Fechas
                                            <component
                                                :is="getSortIcon('fecha_salida')"
                                                v-if="getSortIcon('fecha_salida')"
                                                class="h-4 w-4 ml-1"
                                            />
                                        </div>
                                    </th>
                                    ...
                                    >
                                        <div class="flex items-center">
                                            Cupos
                                            <component
                                                :is="getSortIcon('cupos_disponibles')"
                                                v-if="getSortIcon('cupos_disponibles')"
                                                class="h-4 w-4 ml-1"
                                            />
                                        </div>
                                    </th>
                            ...
                            >
                                ...
                                >
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                >
                                                    ...
                                                    {{ viaje.plan_viaje?.destino?.nombre_lugar }}, {{ viaje.plan_viaje?.destino?.ciudad }}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="text-sm text-gray-500 dark:text-gray-400">
                                            hasta {{ formatDate(viaje.fecha_retorno) }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-1">
                                                <div class="flex items-center justify-between text-sm mb-1">
                                                    <span class="text-gray-900 dark:text-gray-100">
                                                        {{ viaje.cupos_totales - viaje.cupos_disponibles }} / {{ viaje.cupos_totales }}
                                                    </span>
                                                    <span class="text-gray-500 dark:text-gray-400 text-xs">
                                                        {{ Math.round(((viaje.cupos_totales - viaje.cupos_disponibles) / viaje.cupos_totales) * 100) }}%
                                                    </span>
                                                </div>
                                    ...
                                    >
                                        <div class="flex justify-end space-x-2">
                                            ...
                                            <button
                                                ...
                                                title="Eliminar"
                                                :disabled="viaje.ventas_count > 0"
                                                :class="{ 'opacity-50 cursor-not-allowed': viaje.ventas_count > 0 }"
                                            >
                                ...
                                <tr v-if="viajes.data.length === 0">
                                    ...
                                    >
                                        ...
                                        <p class="text-lg font-medium">No se encontraron viajes programados</p>
                                        <p class="text-sm mt-1">
                                            Prueba ajustando los filtros o programa un nuevo viaje
                                        </p>
                                        <Link
                                            :href="route('viajes.create')"
                    ...
                    >
                        <div class="flex items-center justify-between">
                            <div class="text-sm text-gray-700 dark:text-gray-300">
                                Mostrando
                                <span class="font-medium">{{ viajes.from }}</span>
                                a
                                <span class="font-medium">{{ viajes.to }}</span>
                                de
                                <span class="font-medium">{{ viajes.total }}</span>
                                resultados
                            </div>
                            <div class="flex space-x-1">
                                <template v-for="link in viajes.links" :key="link.label">
                                    <Link
                                        v-if="link.url"
                                        :href="link.url"

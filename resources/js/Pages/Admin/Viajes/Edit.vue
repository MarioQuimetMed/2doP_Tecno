...
const form = useForm({
    ...
    fecha_salida:
        props.viaje.fecha_salida?.split("T")[0] || props.viaje.fecha_salida,
                ...
                >
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            >
                                Este viaje tiene {{ cuposVendidos }} cupo(s)
                                vendido(s). No podrá reducir los cupos por
                            ...
                            >
                                <div class="p-6">
                                    ...
                                    <div>
                                        ...
                                        >
                                            No se puede cambiar el plan porque
                                            hay ventas asociadas
                                        </p>
                                        <InputError
                                            class="mt-2"

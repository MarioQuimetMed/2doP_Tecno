...
const aplicarFiltros = () => {
    router.get(route("reportes.ocupacion-viajes"), {
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <a
                    :href="route('reportes.exportar-ocupacion-excel', filtros)"
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Ocupación Promedio</p>
                        <p class="text-2xl font-bold text-purple-600">
                            {{ estadisticas.ocupacion_promedio }}%
                        </p>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Viajes Llenos</p>
                        <p class="text-2xl font-bold text-emerald-600">
                            {{ estadisticas.viajes_llenos }}
                        </p>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Con Disponibilidad</p>
                        <p class="text-2xl font-bold text-blue-600">
                            {{ estadisticas.viajes_disponibles }}
                        </p>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Cupos Vendidos</p>
                        <p class="text-2xl font-bold text-amber-600">
                            {{ estadisticas.cupos_vendidos }}
                        </p>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Cupos Totales</p>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <tr v-for="viaje in viajes" :key="viaje.id" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="text-sm text-gray-900 dark:text-gray-100">
                                            {{ viaje.cupos_vendidos }} / {{ viaje.cupos_totales }}
                                        </div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400">
                                            {{ viaje.cupos_disponibles }} disponibles
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                                ...
                                                <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                                                    <div
                                                        :class="[
                                                            ...
                                                            getOcupacionColor(viaje.porcentaje_ocupacion)
                                                        ]"
                                                        :style="{ width: viaje.porcentaje_ocupacion + '%' }"
                                                    ></div>
                                                </div>
                                            </div>
                                        </div>

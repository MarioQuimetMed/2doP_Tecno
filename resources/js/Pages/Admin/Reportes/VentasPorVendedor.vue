...
const aplicarFiltros = () => {
    router.get(route("reportes.ventas-vendedor"), {
...
const vendedoresRanking = computed(() => {
    ...
    return [...props.vendedores].sort((a, b) => b.total_ingresos - a.total_ingresos);
});
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <a
                    :href="route('reportes.exportar-ventas', { ...filtros, formato: 'excel' })"
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <h3 class="font-medium text-gray-900 dark:text-gray-100">Período de Análisis</h3>
                    </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Vendedores Activos</p>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Promedio por Vendedor</p>
                ...
                <div class="grid lg:grid-cols-3 gap-6 mb-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <div class="flex items-center gap-2 mb-4">
                            ...
                            <h3 class="font-medium text-gray-900 dark:text-gray-100">Ranking de Vendedores</h3>
                        </div>
                        <div class="space-y-3">
                            <div
                                v-for="(vendedor, index) in vendedoresRanking.slice(0, 5)"
                                :key="vendedor.id"
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <tr
                                    v-for="(vendedor, index) in vendedoresRanking"
                                    :key="vendedor.id"
                                ...
                                >
                                    ...
                                    <td class="px-6 py-4 text-sm text-right text-gray-900 dark:text-gray-100">
                                        {{ formatCurrency(vendedor.ticket_promedio) }}
                                    </td>
                                        ...
                                        <span class="inline-flex items-center">
                                            ...
                                            <div class="ml-2 w-16 bg-gray-200 rounded-full h-2">
                                                <div
                                                    ...
                                                    :style="{ width: `${vendedor.porcentaje_total}%` }"
                                                ></div>
                                            </div>
                                        </span>
                                    </td>
                            ...
                            <tfoot class="bg-gray-100 dark:bg-gray-700">
                                <tr>
                                    <td colspan="3" class="px-6 py-3 text-sm font-bold text-gray-900 dark:text-gray-100">
                                        TOTALES
                                    </td>
                                    <td class="px-6 py-3 text-sm text-center font-bold text-gray-900 dark:text-gray-100">
                                        {{ totales?.total_ventas || 0 }}
                                    </td>
                                    <td class="px-6 py-3 text-sm text-right font-bold text-emerald-600">
                                        {{ formatCurrency(totales?.total_ingresos) }}
                                    </td>
                                    <td colspan="2"></td>
                                </tr>

...
const aplicarFiltros = () => {
    router.get(route("reportes.pagos-pendientes"), {
        tipo: tipo.value,
    }, { preserveState: true });
};
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <a
                    :href="route('reportes.exportar-pagos-excel', filtros)"
        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <label class="flex items-center">
                            ...
                            />
                            <span class="ml-2 text-gray-700 dark:text-gray-300">Todas las pendientes</span>
                        </label>
                        <label class="flex items-center">
                            <input
                                v-model="tipo"
                                ...
                                @change="aplicarFiltros"
                            />
                            <span class="ml-2 text-gray-700 dark:text-gray-300">Solo vencidas</span>
                        </label>
                        <label class="flex items-center">
                            <input
                                v-model="tipo"
                                ...
                                @change="aplicarFiltros"
                            />
                            <span class="ml-2 text-gray-700 dark:text-gray-300">Próximas a vencer (15 días)</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Cuotas Vencidas</p>
                        <p class="text-2xl font-bold text-red-600">
                            {{ estadisticas.cuotas_vencidas }}
                        </p>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Próximas a Vencer</p>
                        <p class="text-2xl font-bold text-amber-600">
                            {{ estadisticas.cuotas_proximas }}
                        </p>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Total Cuotas</p>
                ...
                >
                    <div class="flex items-center">
                        ...
                        <p class="text-sm text-red-800 dark:text-red-200">
                            <strong>¡Atención!</strong> Hay {{ estadisticas.cuotas_vencidas }} cuotas vencidas que requieren seguimiento inmediato.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <tr v-for="cuota in cuotas" :key="cuota.id" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <span
                                            :class="[
                                                ...
                                                getEstadoColor(cuota.dias_vencimiento)
                                            ]"
                                        >
                                            {{

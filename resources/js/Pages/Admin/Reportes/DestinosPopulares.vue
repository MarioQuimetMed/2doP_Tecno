...
const aplicarFiltros = () => {
    router.get(route("reportes.destinos-populares"), {
        limite: limite.value,
...
const totalVentas = computed(() => props.destinos.reduce((sum, d) => sum + d.total_ventas, 0));
const totalIngresos = computed(() => props.destinos.reduce((sum, d) => sum + d.ingresos, 0));
</script>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Destinos Analizados</p>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <tr v-for="(destino, index) in destinos" :key="destino.id" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    <td class="px-6 py-4">
                                        <span
                                            :class="[
                                    ...
                                    <td class="px-6 py-4 text-sm text-right text-gray-600 dark:text-gray-300">
                                        {{ totalVentas ? ((destino.total_ventas / totalVentas) * 100).toFixed(1) : 0 }}%
                                    </td>
                                </tr>

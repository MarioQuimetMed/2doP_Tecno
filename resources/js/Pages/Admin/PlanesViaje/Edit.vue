...
const actividadesIniciales = props.planViaje.actividades_diarias?.map(a => ({
...
watch(() => form.duracion_dias, (newDuracion, oldDuracion) => {
    if (newDuracion > oldDuracion) {
        ...
        for (let i = oldDuracion + 1; i <= newDuracion; i++) {
            ...
            const actividadesDelDia = form.actividades.filter(a => a.dia_numero === i);
                                    ...
                                    <div class="flex items-center mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                                Modifique los datos del plan de viaje
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <p class="mt-1 text-xs text-amber-600 dark:text-amber-400">
                                                    ...
                                                    Cambiar la duración puede afectar las actividades
                                                </p>
                            ...
                            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg sticky top-6">
                                <div class="p-6">
                                    ...
                                    <div class="mt-4 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                                        ...
                                        <dl class="space-y-1 text-xs text-gray-500 dark:text-gray-400">
                                            <div class="flex justify-between">
                                                <dt>Creado:</dt>
                                                <dd>{{ formatDate(planViaje.created_at) }}</dd>
                                            </div>
                                            <div class="flex justify-between">
                                                <dt>Actualizado:</dt>
                                                <dd>{{ formatDate(planViaje.updated_at) }}</dd>
                                            </div>
                                            <div class="flex justify-between">
                                                <dt>ID:</dt>
                                                <dd>#{{ planViaje.id }}</dd>
                                    ...
                                    <div class="mt-6 space-y-3">
                                        ...
                                        <Link
                                            :href="route('planes-viaje.show', planViaje.id)"

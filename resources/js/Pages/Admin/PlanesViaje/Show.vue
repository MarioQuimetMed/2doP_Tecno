...
const deletePlan = () => {
    if (confirm(`¿Está seguro de eliminar el plan "${props.planViaje.nombre}"?`)) {
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <button
                        ...
                        :title="stats.total_viajes > 0 ? 'No se puede eliminar: tiene viajes asociados' : 'Eliminar plan'"
                    >
                    ...
                    <div class="lg:col-span-2 space-y-6">
                                ...
                                <div class="p-6">
                                    <div class="flex items-start justify-between">
                                        <div>
                                            ...
                                            <div class="mt-2 flex items-center text-indigo-600 dark:text-indigo-400">
                                                <MapPinIcon class="h-5 w-5 mr-1" />
                                                <span class="font-medium">
                                                    {{ planViaje.destino.nombre_lugar }}
                                                </span>
                                            </div>
                                            <div class="mt-1 flex items-center text-gray-500 dark:text-gray-400 text-sm">
                                                <GlobeAltIcon class="h-4 w-4 mr-1" />
                                                {{ planViaje.destino.ciudad }}, {{ planViaje.destino.pais }}
                                            </div>
                                        </div>
                                        <div class="text-right">
                                            <div class="text-3xl font-bold text-indigo-600 dark:text-indigo-400">
                                                {{ formatCurrency(planViaje.precio_base) }}
                                            </div>
                                    ...
                                    <div class="mt-4 flex flex-wrap gap-2">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">
                                            ...
                                            {{ planViaje.duracion_dias }} {{ planViaje.duracion_dias === 1 ? 'día' : 'días' }}
                                        </span>
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200">
                                            <CheckCircleIcon class="h-4 w-4 mr-1" />
                                            {{ stats.total_actividades }} actividades
                                        </span>
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200">
                                            ...
                                            {{ stats.total_viajes }} viajes programados
                                        </span>
                                    </div>

                                    <!-- Descripción -->
                                    <div v-if="planViaje.descripcion" class="mt-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                    ...
                                    >
                                        ...
                                        <div class="flex items-center mb-4">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                                    {{ actividadesPorDia[dia]?.length || 0 }} actividades programadas
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="ml-6 pl-10 space-y-3">
                                            ...
                                            >
                                                ...
                                                <div class="absolute -left-10 top-1/2 -translate-y-1/2 h-3 w-3 rounded-full bg-indigo-500 border-2 border-white dark:border-gray-800"></div>
                                                
                                                <!-- Hora -->
                                                <div v-if="actividad.hora_inicio" class="flex-shrink-0 mr-4">
                                            ...
                                            >
                                                <ExclamationCircleIcon class="h-5 w-5 text-amber-500 mr-3" />
                                ...
                                >
                                    <CalendarDaysIcon class="h-16 w-16 mx-auto text-gray-300 dark:text-gray-600 mb-4" />
                                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">
                                        Sin itinerario definido
                                    </h3>
                                    <p class="text-gray-500 dark:text-gray-400 mb-4">
                                        Este plan aún no tiene actividades programadas
                                    </p>
                                    <Link
                                        :href="route('planes-viaje.edit', planViaje.id)"
                            ...
                            <div class="p-6">
                                ...
                                <dl class="space-y-4">
                                    <div class="flex justify-between items-center">
                                        <dt class="text-sm text-gray-500 dark:text-gray-400">Precio base</dt>
                                    ...
                                    <div class="flex justify-between items-center">
                                        <dt class="text-sm text-gray-500 dark:text-gray-400">Actividades</dt>
                                        <dd class="text-sm font-semibold text-gray-900 dark:text-gray-100">
                                            {{ stats.total_actividades }}
                                        </dd>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <dt class="text-sm text-gray-500 dark:text-gray-400">Viajes programados</dt>
                                        <dd class="text-sm font-semibold text-gray-900 dark:text-gray-100">
                                            {{ stats.total_viajes }}
                                        </dd>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <dt class="text-sm text-gray-500 dark:text-gray-400">Viajes activos</dt>
                                        <dd>
                                            <span
                                                :class="[
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <Link
                                            :href="route('destinos.show', planViaje.destino.id)"
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                                    {{ viaje.ventas_count || 0 }} ventas
                                                </p>
                                            </div>
                                            <span
                                                :class="[
                                                    'px-2 py-1 text-xs rounded-full font-medium',
                                                    viaje.estado === 'ABIERTO' ? 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200' :
                                                    viaje.estado === 'LLENO' ? 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200' :
                                                    viaje.estado === 'EN_CURSO' ? 'bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200' :
                                                    'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300'
                                                ]"
                                            >
                                                {{ viaje.estado }}
                            ...
                            <div class="p-6">
                                ...
                                <dl class="space-y-2 text-sm">
                                    <div>
                                        ...
                                        <dd class="font-mono text-gray-900 dark:text-gray-100">#{{ planViaje.id }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-gray-500 dark:text-gray-400">Creado</dt>
                                        <dd class="text-gray-900 dark:text-gray-100">{{ formatDate(planViaje.created_at) }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-gray-500 dark:text-gray-400">Última actualización</dt>
                                        <dd class="text-gray-900 dark:text-gray-100">{{ formatDate(planViaje.updated_at) }}</dd>
                                    </div>
                                </dl>
                            </div>
                        </div>

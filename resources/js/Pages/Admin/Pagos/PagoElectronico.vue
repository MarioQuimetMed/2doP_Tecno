...
const isFormValid = computed(() => {
    if (selectedMetodo.value === "TARJETA") {
        return (
            form.numero_tarjeta.replace(/\s/g, "").length >= 15 &&
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
                ...
                <div
                    v-if="venta"
                    class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg p-6 text-white mb-6"
                >
                    <div class="flex justify-between items-start">
                        ...
                        <div class="text-right">
                            ...
                            <p v-if="cuota" class="text-blue-200 text-sm">
                ...
                >
                    ...
                    <div v-if="currentStep === 1" class="p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            >
                                ...
                                <div
                                    v-if="selectedMetodo === metodo.value"
                                    class="ml-auto"
                                >
                                    <CheckCircleIcon
                    ...
                    <div v-if="currentStep === 2" class="p-6">
                        ...
                        >
                            <div>
                                ...
                                <InputError
                                    :message="form.errors.numero_tarjeta"
                                    class="mt-2"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                />
                                <InputError
                                    :message="form.errors.nombre_titular"
                                    class="mt-2"
                                />
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    />
                                    <InputError
                                        :message="form.errors.fecha_expiracion"
                                        class="mt-2"
                                    />
                                </div>
                            ...
                            <div
                                class="flex items-center text-sm text-gray-500 dark:text-gray-400 mt-4"
                            >
                        ...
                        <!-- Código QR -->
                        <div
                            v-if="selectedMetodo === 'QR'"
                            class="text-center py-8"
                        >
                            <div
                                class="inline-block p-4 bg-white rounded-lg shadow-lg mb-4"
                            >
                                <!-- QR Code simulado -->
                                <div
                                    class="w-48 h-48 bg-gray-100 flex items-center justify-center border-2 border-gray-300"
                                >
                        ...
                        <!-- Datos de Transferencia -->
                        <div
                            v-if="selectedMetodo === 'TRANSFERENCIA'"
                            class="space-y-4"
                        >
                            <div
                                ...
                                <div class="space-y-2 text-sm">
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                            ...
                                            >Banco Nacional de Bolivia</span
                                        >
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-500"
                            ...
                            >
                                ...
                                >
                                    <strong>Importante:</strong> Incluya el
                                    número de venta
                        ...
                        <div class="mt-6 flex justify-between">
                            ...
                            <PrimaryButton
                                @click="nextStep"
                                :disabled="
                                    selectedMetodo === 'TARJETA' && !isFormValid
                                "
                            >
                                Continuar
                            </PrimaryButton>
                        ...
                        <div class="space-y-4">
                            ...
                            >
                                <div class="space-y-3 text-sm">
                                    ...
                                    <div
                                        class="flex justify-between border-t border-gray-200 dark:border-gray-600 pt-3"
                                    >
                                        <span
                            ...
                            <!-- Aviso de seguridad -->
                            <div
                                class="flex items-start p-4 bg-green-50 dark:bg-green-900/20 rounded-lg"
                            >
                                <ShieldCheckIcon
                                    class="h-6 w-6 text-green-600 dark:text-green-400 mr-3 flex-shrink-0"
                                />
                                <div>
                                    <p
                                    ...
                                    >
                                        ...
                                        electrónico. En producción, se
                                        integraría con pasarelas de pago reales.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div
                                v-if="paymentError"
                                class="flex items-start p-4 bg-red-50 dark:bg-red-900/20 rounded-lg"
                            >
                                <ExclamationTriangleIcon
                                    class="h-6 w-6 text-red-600 dark:text-red-400 mr-3 flex-shrink-0"
                                />
                                <div>
                                    <p
                    ...
                    <div v-if="currentStep === 4" class="p-6 text-center">
                        ...
                        <div
                            class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg inline-block mb-6"
                        >

    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <Link
                    ...
                    :href="resolveUrl('pagos/create?venta_id=' + venta.id)"
        ...
        <div class="py-12">
            <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
                ...
                <div
                    class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg p-6 text-white mb-6"
                >
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <div class="flex items-center text-indigo-100 mb-2">
                                ...
                                {{ venta.viaje?.plan_viaje?.destino?.ciudad }}
                            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2">
                            ...
                            <div class="p-6">
                                ...
                                >
                                    ...
                                    >
                                        <!-- Número de pago -->
                                        <div
                                            class="absolute -left-3 -top-3 w-8 h-8 bg-green-500 text-white rounded-full flex items-center justify-center font-bold text-sm"
                                        >
                                            {{ venta.pagos.length - index }}
                                        </div>

                                        <div
                                            class="flex items-start justify-between ml-4"
                                        >
                                            <div class="flex-1">
                                                <div
                        ...
                        <div
                            v-if="venta.plan_pago?.cuotas?.length"

...
const getMetodoBgClass = (metodo) => {
    const classes = {
        EFECTIVO: "bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300",
        TARJETA: "bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300",
        QR: "bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300",
        TRANSFERENCIA: "bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-300",
    };
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Recaudado Hoy</p>
                                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">
                                    {{ formatCurrency(stats.monto_hoy) }}
                                </p>
                            </div>
                            <div class="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-full">
                                <CalendarDaysIcon class="h-8 w-8 text-blue-600 dark:text-blue-400" />
                            </div>
                        </div>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-gray-500 dark:text-gray-400">En Efectivo</p>
                                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">
                                    {{ formatCurrency(stats.por_metodo?.efectivo) }}
                                </p>
                            </div>
                            <div class="p-3 bg-emerald-100 dark:bg-emerald-900/30 rounded-full">
                                <BanknotesIcon class="h-8 w-8 text-emerald-600 dark:text-emerald-400" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Pago Electrónico</p>
                                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">
                                    {{ formatCurrency((stats.por_metodo?.tarjeta || 0) + (stats.por_metodo?.qr || 0) + (stats.por_metodo?.transferencia || 0)) }}
                                </p>
                            </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                ...
                                >
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900 dark:text-gray-100">
                                            {{ pago.venta?.viaje?.plan_viaje?.nombre || 'N/A' }}
                                        </div>
                                        <div class="text-sm text-gray-500 dark:text-gray-400">
                                            {{ pago.venta?.viaje?.plan_viaje?.destino?.nombre_lugar || '' }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div v-if="pago.cuota" class="text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <!-- Paginación -->
                    <div v-if="pagos.data.length > 0" class="px-6 py-4 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-between">

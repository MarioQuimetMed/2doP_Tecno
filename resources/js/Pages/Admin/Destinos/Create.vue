                ...
                >
                    <div class="p-6">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        Complete los datos del nuevo destino turístico
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <!-- Preview Card -->
                            <div v-if="form.nombre_lugar || form.ciudad || form.pais" class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-900">

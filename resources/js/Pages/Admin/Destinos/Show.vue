    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            ...
                            <div class="h-48 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 relative">
                                ...
                                <div class="absolute bottom-0 left-0 right-0 p-6">
                                    <div class="flex items-end">
                                        <div class="flex-shrink-0 h-20 w-20 rounded-xl bg-white dark:bg-gray-800 shadow-lg flex items-center justify-center">
                                            <MapPinIcon class="h-10 w-10 text-indigo-600" />
                                        </div>
                                        <div class="ml-4 mb-1">
                            ...
                            <div class="p-6">
                                <div class="mb-6">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400 whitespace-pre-line">
                                        {{ destino.descripcion || 'Este destino aún no tiene una descripción.' }}
                                    </p>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4 py-4 border-t border-gray-200 dark:border-gray-700">
                                    <div>
                                        <span class="text-sm text-gray-500 dark:text-gray-400">País</span>
                                        <p class="font-medium text-gray-900 dark:text-gray-100">{{ destino.pais }}</p>
                                    </div>
                                    <div>
                                        <span class="text-sm text-gray-500 dark:text-gray-400">Ciudad</span>
                                        <p class="font-medium text-gray-900 dark:text-gray-100">{{ destino.ciudad }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg">
                                    <div class="flex items-center">
                                        ...
                                        <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">Planes de Viaje</span>
                                    </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                            ...
                            <div class="space-y-3 text-sm">
                                <div class="flex items-center text-gray-600 dark:text-gray-400">
                                    ...
                                    <span>Creado: {{ formatDate(destino.created_at) }}</span>
                                </div>
                                <div class="flex items-center text-gray-600 dark:text-gray-400">
                                    <ClockIcon class="h-4 w-4 mr-2" />
                                    <span>Actualizado: {{ formatDate(destino.updated_at) }}</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-6" v-if="destino.planes_viaje && destino.planes_viaje.length > 0">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">

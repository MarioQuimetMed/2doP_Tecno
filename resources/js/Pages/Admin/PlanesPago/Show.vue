...
const openPaymentModal = (cuota) => {
    ...
    const saldoPendiente = cuota.monto_total_cuota - (cuota.pagos?.reduce((sum, p) => sum + parseFloat(p.monto_pagado), 0) || 0);
...
const calcularSaldoCuota = (cuota) => {
    const pagado = cuota.pagos?.reduce((sum, p) => sum + parseFloat(p.monto_pagado), 0) || 0;
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Plan #{{ planPago.id }} - Venta #{{ planPago.venta.id }}
                        </p>
                    </div>
                </div>
                <Link
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    Tel: {{ planPago.venta.cliente.telefono || 'N/A' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                            ...
                            <div class="p-4">
                                <p class="font-medium text-gray-900 dark:text-white">
                                    {{ planPago.venta.viaje?.plan_viaje?.destino?.nombre || 'Sin destino' }}
                                </p>
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    {{ planPago.venta.viaje?.plan_viaje?.nombre || 'Sin plan' }}
                                </p>
                                <div class="mt-2 flex items-center text-sm text-gray-500 dark:text-gray-400">
                                    <CalendarDaysIcon class="h-4 w-4 mr-1" />
                                    {{ formatShortDate(planPago.venta.viaje?.fecha_salida) }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                            ...
                            <div class="p-4 space-y-3">
                                <div class="flex justify-between">
                                    <span class="text-gray-600 dark:text-gray-400">Monto Original:</span>
                                ...
                                <div class="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2">
                                    <span class="text-gray-600 dark:text-gray-400">Total con Intereses:</span>
                                    <span class="font-bold text-gray-900 dark:text-white">
                                        {{ formatMoney(resumen.monto_total_con_intereses) }}
                                    </span>
                                </div>
                                <div class="flex justify-between text-green-600">
                                    <span>Total Pagado:</span>
                                    <span class="font-medium">{{ formatMoney(resumen.total_pagado) }}</span>
                                </div>
                                <div class="flex justify-between text-red-600 font-semibold">
                                    <span>Saldo Pendiente:</span>
                                    <span>{{ formatMoney(resumen.saldo_pendiente) }}</span>
                                </div>
                                ...
                                <div class="mt-4 grid grid-cols-3 gap-2 text-center">
                                    <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-2">
                                        <p class="text-lg font-bold text-green-600">{{ resumen.cuotas_pagadas }}</p>
                                        <p class="text-xs text-gray-600 dark:text-gray-400">Pagadas</p>
                                    </div>
                                    <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-2">
                                        <p class="text-lg font-bold text-yellow-600">{{ resumen.cuotas_pendientes }}</p>
                                        <p class="text-xs text-gray-600 dark:text-gray-400">Pendientes</p>
                                    </div>
                                    <div class="bg-red-50 dark:bg-red-900/20 rounded-lg p-2">
                                        <p class="text-lg font-bold text-red-600">{{ resumen.cuotas_vencidas }}</p>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                            ...
                            <div class="space-y-2 text-sm">
                                <div class="flex justify-between">
                                    <span class="text-gray-600 dark:text-gray-400">Cantidad de Cuotas:</span>
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        {{ planPago.cantidad_cuotas }}
                                    </span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600 dark:text-gray-400">Tasa de Interés:</span>
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        {{ planPago.tasa_interes }}%
                                    </span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600 dark:text-gray-400">Día de Vencimiento:</span>
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        Día {{ planPago.dia_vencimiento_mensual }} de cada mes
                                    </span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600 dark:text-gray-400">Fecha de Venta:</span>
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        {{ formatShortDate(planPago.venta.fecha_venta) }}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
                            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center">
                                    <CalendarDaysIcon class="h-5 w-5 mr-2 text-purple-600" />
                            ...
                            <div class="divide-y divide-gray-200 dark:divide-gray-700">
                                <div
                                    ...
                                    :class="{
                                        'bg-red-50 dark:bg-red-900/10': cuota.estado_cuota === 'VENCIDO',
                                        'bg-green-50 dark:bg-green-900/10': cuota.estado_cuota === 'PAGADO'
                                    }"
                                >
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div
                                                ...
                                                :class="{
                                                    'bg-green-500': cuota.estado_cuota === 'PAGADO',
                                                    'bg-yellow-500': cuota.estado_cuota === 'PENDIENTE',
                                                    'bg-red-500': cuota.estado_cuota === 'VENCIDO'
                                                }"
                                            >
                                                {{ cuota.numero_cuota }}
                                            </div>
                                            ...
                                            <div>
                                                <div class="flex items-center space-x-2">
                                                    <span class="font-medium text-gray-900 dark:text-white">
                                                        Cuota {{ cuota.numero_cuota }} de {{ planPago.cantidad_cuotas }}
                                                    </span>
                                                    <span
                                                        :class="getEstadoCuotaClass(cuota.estado_cuota)"
                                                ...
                                                <div class="flex items-center text-sm text-gray-500 dark:text-gray-400 mt-1">
                                                    ...
                                                    <template v-if="cuota.estado_cuota === 'PENDIENTE'">
                                                        <span
                                                            class="ml-2 px-2 py-0.5 rounded text-xs"
                                                            :class="diasRestantes(cuota.fecha_vencimiento) < 0 
                                                                ? 'bg-red-100 text-red-700' 
                                                                : diasRestantes(cuota.fecha_vencimiento) <= 7 
                                                                    ? 'bg-yellow-100 text-yellow-700'
                                                                    : 'bg-gray-100 text-gray-700'"
                                                        >
                                                            {{ diasRestantes(cuota.fecha_vencimiento) < 0 
                                                                ? `Vencida hace ${Math.abs(diasRestantes(cuota.fecha_vencimiento))} días`
                                                                : `${diasRestantes(cuota.fecha_vencimiento)} días restantes`
                                                            }}
                                                        </span>
                                                    </template>
                                                </div>
                                        ...
                                        <div class="text-right">
                                            <div class="text-lg font-bold text-gray-900 dark:text-white">
                                                {{ formatMoney(cuota.monto_total_cuota) }}
                                            </div>
                                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                                Capital: {{ formatMoney(cuota.monto_capital) }} |
                                                Interés: {{ formatMoney(cuota.monto_interes) }}
                                            </div>
                                            <div v-if="calcularSaldoCuota(cuota) < cuota.monto_total_cuota && cuota.estado_cuota !== 'PAGADO'" class="text-xs text-blue-600 mt-1">
                                                Pagado: {{ formatMoney(cuota.monto_total_cuota - calcularSaldoCuota(cuota)) }}
                                            </div>
                                        </div>
                                    </div>

                                    <!-- Pagos de esta cuota -->
                                    <div v-if="cuota.pagos && cuota.pagos.length > 0" class="mt-3 ml-16">
                                        <div class="text-xs text-gray-500 dark:text-gray-400 mb-2">Pagos realizados:</div>
                                        <div class="space-y-1">
                                            <div
                                            ...
                                            >
                                                <span class="text-gray-600 dark:text-gray-400">
                                                    {{ formatShortDate(pago.fecha_pago) }} - {{ pago.metodo_pago }}
                                                </span>
                                    ...
                                    <!-- Botón de pagar -->
                                    <div v-if="puedeRecibirPago(cuota)" class="mt-3 ml-16">
                                        <button
                                        ...
                                        >
                                            ...
                                            Registrar Pago
                                            <span v-if="calcularSaldoCuota(cuota) < cuota.monto_total_cuota" class="ml-1">
                                                (Saldo: {{ formatMoney(calcularSaldoCuota(cuota)) }})
                                            </span>
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div v-if="planPago.venta.pagos && planPago.venta.pagos.length > 0" class="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow">
                            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center">
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                        <tr v-for="pago in planPago.venta.pagos" :key="pago.id">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                                {{ formatShortDate(pago.fecha_pago) }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                                {{ pago.cuota_id ? `Cuota #${planPago.cuotas.find(c => c.id === pago.cuota_id)?.numero_cuota || pago.cuota_id}` : 'Pago inicial' }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                                {{ pago.metodo_pago }}
                                            </td>
                                    ...
                                    <tfoot class="bg-gray-50 dark:bg-gray-700">
                                        <tr>
                                            <td colspan="4" class="px-6 py-3 text-right text-sm font-medium text-gray-900 dark:text-white">
                                                Total Pagado:
                                            </td>
        ...
        <Teleport to="body">
            ...
            >
                <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
                    ...
                    <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl transform transition-all sm:max-w-lg sm:w-full">
                        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                            <div class="flex items-center justify-between">
                        ...
                        <form @submit.prevent="submitPayment" class="p-6">
                            <div class="space-y-4">
                                ...
                                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                    <div class="flex justify-between text-sm">
                                        <span class="text-gray-600 dark:text-gray-400">Monto de la cuota:</span>
                                        <span class="font-medium text-gray-900 dark:text-white">
                                            {{ formatMoney(selectedCuota?.monto_total_cuota) }}
                                        </span>
                                    </div>
                                    <div class="flex justify-between text-sm mt-1">
                                        <span class="text-gray-600 dark:text-gray-400">Saldo pendiente:</span>
                                        <span class="font-medium text-red-600">
                                            {{ formatMoney(calcularSaldoCuota(selectedCuota)) }}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input
                                            ...
                                            step="0.01"
                                            min="0.01"
                                            :max="calcularSaldoCuota(selectedCuota)"
                                    ...
                                    <p v-if="paymentForm.errors.monto" class="mt-1 text-sm text-red-600">
                                ...
                                <div>
                                    ...
                                    <p v-if="paymentForm.errors.metodo_pago" class="mt-1 text-sm text-red-600">
                            ...
                            <div class="mt-6 flex justify-end space-x-3">
                                ...
                                >
                                    <span v-if="paymentForm.processing">Procesando...</span>

            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-5 border-l-4 border-purple-500">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="p-3 bg-purple-100 dark:bg-purple-900 rounded-full">
                                <CreditCardIcon class="h-8 w-8 text-purple-600 dark:text-purple-400" />
                            </div>
                        </div>
                        <div class="mt-3 flex items-center text-sm">
                            <span class="text-green-600 font-medium">{{ stats.planes_completados }}</span>
                            <span class="text-gray-500 dark:text-gray-400 ml-1">completados</span>
                            <span class="mx-2 text-gray-300">|</span>
                            <span class="text-blue-600 font-medium">{{ stats.planes_activos }}</span>
                            <span class="text-gray-500 dark:text-gray-400 ml-1">activos</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-5 border-l-4 border-yellow-500">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="p-3 bg-yellow-100 dark:bg-yellow-900 rounded-full">
                                <BanknotesIcon class="h-8 w-8 text-yellow-600 dark:text-yellow-400" />
                            </div>
                        </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-5 border-l-4 border-red-500">
                        ...
                        <div class="mt-3 text-sm">
                            <span class="text-red-600 font-medium">{{ stats.cuotas_vencidas }}</span>
                            <span class="text-gray-500 dark:text-gray-400 ml-1">cuotas vencidas</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-5 border-l-4 border-green-500">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="p-3 bg-green-100 dark:bg-green-900 rounded-full">
                                <CurrencyDollarIcon class="h-8 w-8 text-green-600 dark:text-green-400" />
                            </div>
                        </div>
                        <div class="mt-3 text-sm text-gray-500 dark:text-gray-400">
                            En pagos de cuotas
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
                        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-red-50 dark:bg-red-900/20 rounded-t-lg">
                            <div class="flex items-center justify-between">
                                <h3 class="text-lg font-semibold text-red-800 dark:text-red-200 flex items-center">
                                    <ExclamationTriangleIcon class="h-5 w-5 mr-2" />
                                    Cuotas Vencidas
                                    <span class="ml-2 px-2 py-0.5 text-sm bg-red-200 dark:bg-red-800 text-red-800 dark:text-red-200 rounded-full">
                        ...
                        <div class="divide-y divide-gray-200 dark:divide-gray-700 max-h-96 overflow-y-auto">
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div>
                                            <p class="font-medium text-gray-900 dark:text-white">
                                                {{ cuota.plan_pago?.venta?.cliente?.name || 'Cliente' }}
                                            </p>
                                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                                {{ cuota.plan_pago?.venta?.viaje?.plan_viaje?.destino?.nombre || 'Viaje' }}
                                            </p>
                                            <p class="text-xs text-red-600 dark:text-red-400 mt-1">
                                                Vencida hace {{ diasVencida(cuota.fecha_vencimiento) }} días
                                    ...
                                    <div class="text-right">
                                        ...
                                        <Link
                                            ...
                                            :href="route('planes-pago.show', cuota.plan_pago.id)"
                            ...
                            <!-- Empty state -->
                            <div v-if="cuotasVencidas.length === 0" class="p-8 text-center">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
                        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-yellow-50 dark:bg-yellow-900/20 rounded-t-lg">
                            <div class="flex items-center justify-between">
                                <h3 class="text-lg font-semibold text-yellow-800 dark:text-yellow-200 flex items-center">
                                    <ClockIcon class="h-5 w-5 mr-2" />
                                    Próximas a Vencer (7 días)
                                    <span class="ml-2 px-2 py-0.5 text-sm bg-yellow-200 dark:bg-yellow-800 text-yellow-800 dark:text-yellow-200 rounded-full">
                        ...
                        <div class="divide-y divide-gray-200 dark:divide-gray-700 max-h-96 overflow-y-auto">
                                    ...
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-yellow-600 dark:text-yellow-400 mt-1 flex items-center">
                                                ...
                                                Vence en {{ diasRestantes(cuota.fecha_vencimiento) }} días
                                                ({{ formatDate(cuota.fecha_vencimiento) }})
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <!-- Empty state -->
                            <div v-if="cuotasProximas.length === 0" class="p-8 text-center">
                                <CheckCircleIcon class="mx-auto h-12 w-12 text-green-400" />
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                ...
                <div class="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        >
                            <CreditCardIcon class="h-8 w-8 text-purple-600 dark:text-purple-400 mr-3" />
                            <div>
                                <p class="font-medium text-gray-900 dark:text-white">Ver Todos los Planes</p>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Gestionar planes de pago</p>
                            </div>
                        </Link>
                        ...
                        >
                            ...
                            <div>
                                <p class="font-medium text-gray-900 dark:text-white">Planes con Vencidas</p>
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ stats.cuotas_vencidas }} cuotas por cobrar</p>
                            </div>
                        </Link>
                        ...
                        >
                            <BanknotesIcon class="h-8 w-8 text-blue-600 dark:text-blue-400 mr-3" />
                            <div>
                                <p class="font-medium text-gray-900 dark:text-white">Ventas a Crédito</p>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Ver todas las ventas a crédito</p>
                            </div>
                        </Link>
                    </div>
                </div>

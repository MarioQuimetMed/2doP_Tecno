...
const selectedVendedor = ref(props.filters.vendedor_id || "");
const selectedViaje = ref(props.filters.viaje_id || "");
...
const applyFilters = () => {
    router.get(
        "/ventas",
        {
            ...
            viaje_id: selectedViaje.value || undefined,
...
const activeFiltersCount = computed(() => {
    ...
    if (selectedVendedor.value) count++;
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                    ...
                    >
                        <div class="flex items-center">
                            <div
                                class="flex-shrink-0 p-3 bg-emerald-100 dark:bg-emerald-900 rounded-full"
                            >
                                <BanknotesIcon
                ...
                >
                    <div class="p-6">
                        ...
                        <div
                            v-show="showFilters"
                            class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 grid grid-cols-1 md:grid-cols-6 gap-4"
                        >
                            <div>
                                <label

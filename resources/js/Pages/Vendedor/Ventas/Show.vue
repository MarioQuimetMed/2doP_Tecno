...
const openPagoModal = (cuota = null) => {
    ...
    pagoForm.monto = cuota
        ? cuota.monto_total_cuota
        : props.venta.saldo_pendiente;
...
const submitPago = () => {
    pagoForm.post(resolveUrl("vendedor/ventas/" + props.venta.id + "/registrar-pago"), {
        preserveScroll: true,
        onSuccess: () => {
            closePagoModal();
        },
...
const generarQR = () => {
    if (!confirm("¿Desea generar un código QR para pagar esta venta?")) {
        return;
    }
    ...
    router.post(
        resolveUrl("vendedor/ventas/" + props.venta.id + "/generar-qr"),
        {
        ...
        },
        {
            ...
            onSuccess: (page) => {
                ...
                // Buscar el último pago creado en la respuesta
                const ultimoPago =
                    page.props.venta.pagos?.[page.props.venta.pagos.length - 1];

                if (ultimoPago) {
                    // Redirigir a la página de QR
                    router.visit(
                        resolveUrl("vendedor/pagos/" + ultimoPago.id + "/mostrar-qr")
                    );
                }
            },
            onError: () => {
...
const metodoRequiereReferencia = computed(() => {
    const metodo = props.metodosPago.find(
        (m) => m.value === pagoForm.metodo_pago
    );
...
const actividadesPorDia = computed(() => {
    const actividades =
        props.venta.viaje?.plan_viaje?.actividades_diarias || [];
    return actividades.reduce((acc, actividad) => {
        const dia = actividad.dia_numero;
        if (!acc[dia]) {
            acc[dia] = [];
        }
        ...
        <template #header>
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <Link
                        :href="resolveUrl('vendedor/mis-ventas')"
                ...
                <div class="flex space-x-2">
                    <a
                        :href="
                            resolveUrl('vendedor/ventas/' + venta.id + '/comprobante')
                        "
                        target="_blank"
                    ...
                    <a
                        ...
                        :href="resolveUrl('vendedor/ventas/' + venta.id + '/boleto')"
                        target="_blank"
                    ...
                    <button
                        ...
                        class="inline-flex items-center px-4 py-2 bg-purple-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-purple-700 disabled:opacity-50 transition"
                    >
                        <component
                            :is="generandoQR ? ClockIcon : QrCodeIcon"
                            :class="[
                                'h-4 w-4 mr-1',
                                generandoQR && 'animate-spin',
                            ]"
                        />
                        {{ generandoQR ? "Generando..." : "Pagar con QR" }}
                    </button>
                    <button
                        v-if="
                            venta.estado_pago !== 'COMPLETADO' &&
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        >
                            <div class="p-6">
                                ...
                                >
                                    ...
                                    <div
                                        class="flex items-center text-indigo-100 mb-4"
                                    >
                                        <MapPinIcon class="h-5 w-5 mr-1" />
                                        {{
                                            venta.viaje?.plan_viaje?.destino
                                                ?.nombre_lugar
                                        }},
                                        {{
                                            venta.viaje?.plan_viaje?.destino
                        ...
                        <div
                            v-if="
                                venta.tipo_pago === 'CREDITO' && venta.plan_pago
                            "
                            class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg"
                        >
                            <div class="p-6">
                                ...
                                >
                                    ...
                                    >
                                        {{ venta.plan_pago.cantidad_cuotas }}
                                        cuotas -
                                        {{ venta.plan_pago.tasa_interes }}%
                                        interés
                                    </div>
                                </div>
                                ...
                                >
                                    <div
                                        class="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg text-center"
                                    >
                                        <p
                                    ...
                                    <div
                                        class="p-3 bg-red-50 dark:bg-red-900/20 rounded-lg text-center"
                                    >
                                        <p
                                    ...
                                    <div
                                        class="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg text-center"
                                    >
                                        <p
                                ...
                                <div class="overflow-x-auto">
                                    ...
                                    >
                                        ...
                                        >
                                            <tr
                                                v-for="cuota in venta.plan_pago
                                                    .cuotas"
                                                :key="cuota.id"
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <CheckCircleIcon
                                                        v-else
                                                        class="h-5 w-5 text-green-500 inline"
                                                    />
                                                </td>
                                            </tr>
                                        </tbody>
                            ...
                            <div class="p-6">
                                ...
                                >
                                    ...
                                    >
                                        <div class="flex items-center">
                                            <div
                                                class="flex-shrink-0 w-10 h-10 rounded-full bg-green-100 dark:bg-green-800 flex items-center justify-center"
                                            >
                                                <CheckCircleIcon
                                ...
                                >
                                    <BanknotesIcon
                                        class="h-12 w-12 mx-auto mb-2 text-gray-300 dark:text-gray-600"
                                    />
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p
                                            v-if="venta.cliente?.telefono"
                                            class="text-sm text-gray-500 dark:text-gray-400"
                                        >
                                            Tel: {{ venta.cliente?.telefono }}
                                        </p>
                                        <p
                                            v-if="venta.cliente?.ci_nit"
                                            class="text-sm text-gray-500 dark:text-gray-400"
                                        >
                        ...
                        >
                            <div class="p-6">
                                ...
                                <div class="flex items-center">
                                    <div
                                        class="flex-shrink-0 h-12 w-12 rounded-full bg-gradient-to-br from-purple-500 to-pink-600 flex items-center justify-center"
                                    >
                                        <UserIcon class="h-6 w-6 text-white" />
                                    </div>
                                    <div class="ml-4">
            ...
            <div class="p-6">
                ...
                <form @submit.prevent="submitPago" class="space-y-4">
                    ...
                    <div>
                        ...
                        <InputError
                            :message="pagoForm.errors.metodo_pago"
                            class="mt-2"
                        />
                    </div>
                    ...
                    <div v-if="metodoRequiereReferencia">
                        ...
                        />
                        <InputError
                            :message="pagoForm.errors.referencia"
                            class="mt-2"
                        />
                    </div>

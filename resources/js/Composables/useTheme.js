...
export function useTheme() {
    ...
    const fontSizes = [
        ...
        { id: 'extra_grande', nombre: 'Extra Grande', icon: 'A', class: 'text-xl' },
    ];
    ...
    const saveToLocalStorage = () => {
        try {
            ...
            localStorage.setItem(STORAGE_KEYS.HIGH_CONTRAST, highContrast.value.toString());
            localStorage.setItem(STORAGE_KEYS.AUTO_MODE, autoMode.value.toString());
        } catch (e) {
    ...
    const loadFromLocalStorage = () => {
        try {
            ...
            if (savedAutoMode !== null) autoMode.value = savedAutoMode === 'true';
    ...
    const saveToServer = () => {
        ...
        fetch(route('preferencias.update'), {
            method: 'POST',
            headers: {
